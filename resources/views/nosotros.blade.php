            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-7 space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                        <div class="glass-card p-4 rounded-2xl border border-slate-800 space-y-1.5">
                    ...
                    <div class="pt-4 flex flex-wrap gap-4">
                        <a href="https://api.whatsapp.com/send?phone=56949877316&text=Hola%20Domingo,%20necesito%20atencion%20tecnica%20de%20SellafuGas" target="_blank"
                           class="px-6 py-3.5 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black text-sm rounded-xl shadow-lg shadow-emerald-500/25 transition-all flex items-center gap-2">
                            <i data-lucide="message-circle" class="w-4 h-4"></i>
                            <span>Hablar con Domingo Isain por WhatsApp</span>
                        </a>
                        <a href="tel:+56949877316"
                           class="px-6 py-3.5 bg-slate-800 hover:bg-slate-700 text-white font-bold text-sm rounded-xl border border-slate-700 transition-all flex items-center gap-2">
                ...
                <div class="lg:col-span-5 space-y-6">
                    <div class="glass-card p-5 rounded-3xl border border-slate-700 overflow-hidden shadow-2xl space-y-4">
