    ...
    <header class="glass-dark border-b border-slate-800/80 sticky top-[37px] z-40" x-data="{ mobileNav: false, megaMenuNav: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            ...
            <nav class="hidden lg:flex items-center gap-5 text-xs font-semibold text-slate-300">
                <a href="{{ route('home') }}" class="text-white hover:text-sky-400 transition-colors">Inicio</a>
                
                <!-- Services Dropdown Mega Menu -->
                <div class="relative" @mouseenter="megaMenuNav = true" @mouseleave="megaMenuNav = false">
                    <button type="button" class="flex items-center gap-1 hover:text-sky-400 transition-colors py-2 text-slate-200">
                ...
                <a href="{{ route('nosotros') }}" class="hover:text-sky-400 transition-colors">Nosotros</a>
                <a href="{{ route('contacto') }}" class="hover:text-sky-400 transition-colors">Contacto</a>
