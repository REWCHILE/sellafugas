        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="space-y-3 md:col-span-2">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="text-[11px] text-slate-400 block font-semibold">Domingo Isain Plaza Caamaño · Gasfiter Certificado SEC Clase 3</span>
                    </div>
                </div>
            ...
            <div class="space-y-2">
                ...
                <ul class="space-y-1.5 text-xs">
                    ...
                    <li><a href="{{ route('contacto') }}" class="hover:text-sky-400 text-slate-300">Contacto y Central de Urgencias</a></li>
                    <li><a href="{{ route('home') }}#cotizador" class="hover:text-emerald-400 transition-colors">Cotizador de Sellado</a></li>
            ...
            <div class="space-y-2">
                ...
                <p class="text-[11px] text-slate-400">Atención de Lunes a Domingo en Región Metropolitana, V y VI Región.</p>
                <div class="pt-2">
                    <a href="https://api.whatsapp.com/send?phone=56949877316&text=Hola%20Domingo%2C%20necesito%20atencion%20urgente" target="_blank"
                       class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 hover:bg-emerald-500/30 font-bold text-xs">
